...
#ifndef SRC_PROTOCOL_KDE_KDE_PROTOCOL_MANAGER_H_
#define SRC_PROTOCOL_KDE_KDE_PROTOCOL_MANAGER_H_
...
class KdeProtocolManager final {
 public:
  explicit KdeProtocolManager(core::CompositorPrivate* compositor);
  ~KdeProtocolManager();

  KdeProtocolManager(const KdeProtocolManager&) = delete;
  KdeProtocolManager& operator=(const KdeProtocolManager&) = delete;
...
#endif  // SRC_PROTOCOL_KDE_KDE_PROTOCOL_MANAGER_H_
